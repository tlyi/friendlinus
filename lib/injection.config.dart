...
import 'application/notifications/notification_watcher/notification_watcher_bloc.dart'
    as _i22;
import 'application/profile/profile_actor/profile_actor_bloc.dart' as _i24;
import 'application/profile/profile_form/profile_form_bloc.dart' as _i25;
import 'application/search/search_profile_bloc.dart' as _i27;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i16.IProfileRepository>(() => _i17.ProfileRepository(
      get<_i4.FirebaseFirestore>(), get<_i5.FirebaseStorage>()));
  gh.factory<_i18.ModuleActorBloc>(
      () => _i18.ModuleActorBloc(get<_i16.IProfileRepository>()));
  gh.factory<_i19.ModuleForumWatcherBloc>(
      () => _i19.ModuleForumWatcherBloc(get<_i10.IForumRepository>()));
  gh.factory<_i20.ModuleWatcherBloc>(
      () => _i20.ModuleWatcherBloc(get<_i10.IForumRepository>()));
  gh.factory<_i21.NotifCounterWatcherBloc>(
      () => _i21.NotifCounterWatcherBloc(get<_i14.INotificationRepository>()));
  gh.factory<_i22.NotificationWatcherBloc>(
      () => _i22.NotificationWatcherBloc(get<_i14.INotificationRepository>()));
  gh.factory<_i23.PollWatcherBloc>(
      () => _i23.PollWatcherBloc(get<_i10.IForumRepository>()));
  gh.factory<_i24.ProfileActorBloc>(
      () => _i24.ProfileActorBloc(get<_i16.IProfileRepository>()));
  gh.factory<_i25.ProfileFormBloc>(
      () => _i25.ProfileFormBloc(get<_i16.IProfileRepository>()));
  gh.factory<_i26.SearchForumBloc>(
      () => _i26.SearchForumBloc(get<_i10.IForumRepository>()));
  gh.factory<_i27.SearchProfileBloc>(
      () => _i27.SearchProfileBloc(get<_i16.IProfileRepository>()));
