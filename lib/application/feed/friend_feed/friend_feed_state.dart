...
class FriendFeedState with _$FriendFeedState {
  ...
  const factory FriendFeedState.loadSuccess(List<ForumPost> forums) = _LoadSuccess;
  const factory FriendFeedState.loadLike(List<ForumPost> forums) = _LoadLike;

  const factory FriendFeedState.loadFailure(DataFailure dataFailure) = _LoadFailure;
}
